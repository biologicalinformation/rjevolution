...
Benvenuto! Questo sito cerca di contribuire a chiarire tutti gli aspetti tipicamente fraintesi relativi a salute, qualità di vita, invecchiamento, giovinezza, ringiovanimento, eterna giovinezza, estensione della vita, "immortalità", senso della vita, felicità, coscienza, diversità, evoluzione, inquadrandoli nel contesto biologico, evoluzionistico, psicologico ed etico, cercando di fare una riflessione filosofico-scientifica sistemica basata sulla logica, e non sulla retorica (che qui si cerca di evitare come la morte).

Di questi temi ne parla molto, ma se ne parla quasi sempre male, usando la facile retorica e la superficialità, anche perché abbiamo un'eredità di millenni in cui la biologia molecolare e la neurobiologia non esistevano, la teoria dell'evoluzione nemmeno, quindi si è dovuti ricorrere a vari miti, religioni, ecc..

Il punto centrale di tutto è la *qualità della vita*, lo stare bene, che fondamentalmente si basa sulla salute e sulla prospettiva di felicità. L'**etica** è il punto di partenza e di arrivo di questo sito, nonché il filo conduttore, e gli strumenti principali sono la logica e la biologia.
...
Ho appena visto una trasmissione in cui si parlava della bellezza dopo i 50 anni.
Qualcuno diceva che non aveva paura di invecchiare (già, bisogna farsi "belli" agli occhi del pubblico mostrando di essere impavidi). Evidentemente non sa cosa sia l'invecchiamento, perché se uno non ha paura della propria né altrui disintegrazione, con tutto ciò che a questo si collega, di cosa dovrebbe avere paura? La morte rimane la paura più grande dell'uomo, ma c'è anche quella di invecchiare, ancora poco studiata, essendo sommersi di retorica. E le paure hanno eccome un senso.

Qualcun altro ha detto: "A me quello che fa paura del passare del tempo non è tanto il decadimento fisico, quanto magari quello legato alla salute". E qui se non altro già si tocca un tasto molto importante e condiviso.

OK, peccato che le due parti siano inscindibili: se c'è un decadimento biologico, questo si manifesta sia a livello estetico, sia a livello di salute.
L'invecchiamento è l'accumulo di danni strutturali (a livello molecolare e cellulare, e quindi anche a livelli superiori) ed è alla base sia del decadimento estetico che della perdita di salute, e si manifesta sia esteriormente -- e allora si parla di "estetica" -- che "interiormente" -- e allora si tende a parlare di "salute". Ma sempre di cellule e di funzionalità si parla. Anche la pelle ha una funzione fisiologica protettiva, quindi anche il decadimento della pelle e dei muscoli (che porta a peggioramenti estetici) è perdita di salute. E anche il cervello è fatto di neuroni che sono cellule, quindi c'è anche il decadimento mentale, che è sia cognitivo che emozionale. Anche se di norma appare più lento di quello fisico (essendo il cervello un organo molto particolare), c'è anche quello.
Manca proprio, in generale, la comprensione dei collegamenti biologici tra struttura e funzione, che sono onnipresenti in biologia, essendone uno dei concetti chiave.

Comunque, molto spesso, l'invecchiamento tende ad essere visto solo come una perdita di bellezza, come se non avesse alcun impatto diretto sulla salute.
...
Con le solite eccezioni del caso, c'è invece un profondo legame tra estetica e stato di salute, perché una persona devastata da danni o malattie difficilmente appare in "bello" stato, proprio per motivi strutturali ed evoluzionistici (vedi anche etologia). Cioè, a livello di tendenza generale, la piacevolezza è stata selezionata positivamente se associata alle situazioni favorevoli, quindi quelle piü salutari. [Perché le cose belle ci rendono felici - La Bellezza spiegata | Kurzgesagt – In a Nutshell](https://www.youtube.com/watch?v=-O5kNPlUV7w)

Quindi, anche il concetto di bellezza (piacevolezza) *non* è completamente indipendente dal concetto di salute e benessere, pur considerando tutte le differenze da persona a persona e gli errori associati al processo evolutivo.
Quindi attenzione... questo non vuol dire che *bello = sano* nel 100% dei casi, ma che, purtroppo, *vecchio = non sano = non bello*, nel \~100% dei casi: il fatto di essere strutturalmente vecchi implica il fatto di essere danneggiati, e un danno rilevante è osservabile, e non appare mai piacevole o desiderabile. La persona può essere stimabilissima, validissima, affascinante, ma esteticamente non apparirà attraente, esteticamente piacevole, come quando non danneggiata (un ottantenne di oggi non è mai attraente, né in salute, come sé stesso da ventenne o trentenne, anche considerando il fatto che alcuni invecchiano meglio di altri). Vogliamo negare anche questo? Lo ricordiamo ancora, l'aspetto che contraddistingue un anziano medio è considerato di decrepitudine perché si tratta di danni biologici a pelle, tessuto connettivo, muscoli, ecc.. E i danni mediamente non piacciono perché non sono salutari, e in decenni se ne accumulano tanti (fino a 20-30 anni sono praticamente trascurabili).

Questi sono concetti piuttosto facilmente comprensibili per un biologo o una persona alfabetizzata scientificamente, mentre invece sono difficili da afferrare per chi non ha una formazione scientifica o logica. Alcuni che sentono dire che "il fumo uccide" potrebbero rispondere che la loro nonna fumava ed è morta a 90 anni, credendo di confutare l'*associazione* multifattoriale tra fumo e mortalità. Certo, peccato che su 10 casi di tumore al polmone, 9 siano di fumatori. Anche se, va rilevato, hanno perfettamente ragione a dire che la loro osservazione smentisce l'affermazione "il fumo uccide", se presa letteralmente per come formulata in 3 parole. Il problema è nella comunicazione semplificata, in cui si perde informazione.

Un altro punto cruciale è che l'invecchiamento è tendenzialmente considerato come assolutamente inevitabile, senza la minima valutazione della fondatezza di questa affermazione, senza sapere nulla di cosa sia l'invecchiamento biologico. Si va a dogmi e a ripetizione acritica, senza mai verificare bene, e la coltivazione del dubbio e della problematizzazione del normale/ovvio, alla base di scienza e filosofia, è largamente assente. Invece (come poi verrà spiegato bene nel sito), l'invecchiamento biologico *non* è una legge di natura universale, non è un fatto assolutamente inevitabile che riguarda qualsiasi tipo di sistema, e la letteratura scientifica lo testimonia pienamente.
